...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// nestedFunction can access to the variable internal because is the higher of the myFunction.  
...
function lowPopulationAnimals(array) {
  const lowFilter = array.filter(function(item){
...
console.log(greeting('Lucas', 'Huynh'));
...
const Prop = new CuboidMaker(5, 6, 3);
